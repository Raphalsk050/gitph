...
const api: GitphApi = {
  ...
  stageEntries: (paths) => ipcRenderer.invoke(IPC_CHANNELS.stageEntries, paths),
  unstageEntries: (paths) => ipcRenderer.invoke(IPC_CHANNELS.unstageEntries, paths),
  discardEntries: (paths) => ipcRenderer.invoke(IPC_CHANNELS.discardEntries, paths),
  commitChanges: (request) => ipcRenderer.invoke(IPC_CHANNELS.commitChanges, request),
  getWorkingDiff: (request) => ipcRenderer.invoke(IPC_CHANNELS.workingDiff, request),
